...
<html>
	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
          ...
          <span class="property-value" aria-labelledby="firstName-label" id="firstName"><g:fieldValue bean="${authorInstance}" field="firstName"/></span>
          ...
          <span class="property-value" aria-labelledby="lastName-label" id="lastName"><g:fieldValue bean="${authorInstance}" field="lastName"/></span>
